  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-between items-start md:items-center">
        ...
        {isSuccess && (data.reclamacao[0]?.status === "Pendente" ? <AtenderReclamacao idMulta={id.toString()}></AtenderReclamacao> : ""
        )}
      </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <p
                  className={`font-semibold text-white rounded-md py-1 px-3 inline-block ${data.reclamacao[0]?.status === "Pendente"
                      ? "bg-orange-500"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                {data?.funcionario?.numeroAgente? <>
                <label htmlFor="status" className="block text-gray-700 font-semibold mb-2">
                  Funcionario Atendimento
                </label>
                <p>
                  {data?.funcionario?.numeroAgente? data?.funcionario?.pessoa.nome.split(" ")[0] + " " + data?.funcionario?.pessoa.nome.split(" ")[data?.funcionario?.pessoa.nome.split(" ").length - 1] + " - " + data?.funcionario?.numeroAgente : ""}
                </p>
                </>: ""}
          </div>
            </div>
