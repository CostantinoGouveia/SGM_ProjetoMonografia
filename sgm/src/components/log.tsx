...
function handleLogout() {
    ...
    router.replace("/auth/iniciar-sessao");
}
    return (
        <AlertDialog>
            <AlertDialogTrigger>
            <Button variant={"ghost"} className="hover:bg-black/10 hover:text-muted flex justify-between gap-8"><LogOut /> <span>Sair</span></Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
                <AlertDialogHeader>
