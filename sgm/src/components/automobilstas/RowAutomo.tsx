    ...
    return (
        <TableRow key={automobilista.codAutomobilista}>
            ...
            <TableCell className="flex gap-1">
                ...
                {isSus && dataPessoa.usuario[0].tipoUsuario == "Admin" && (<AlertDelete id={automobilista.codAutomobilista.toString()} handleClick={handleDeleteAutomobilista}><Button variant={"outline"} className=" hover:bg-muted"><Trash2 className="w-5 h-5 text-red-700" /></Button></AlertDelete>)}
            </TableCell>
        </TableRow>
    )
}
